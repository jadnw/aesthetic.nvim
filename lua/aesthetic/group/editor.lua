...
function M.get(spec, conf)
  ...
  return {
    ...
    VertSplit = { fg = spec.bg1 }, -- the column separating vertically split windows
    ...
    Search = inv.search and { style = "inverse" } or { fg = spec.bg2, bg = spec.sel1 }, -- Last search pattern highlighting (see 'hlsearch').  Also used for similar items that need to stand out.
    ...
    Visual = inv.visual and { style = "inverse" } or { fg = spec.bg0, bg = spec.sel1 }, -- Visual mode selection
